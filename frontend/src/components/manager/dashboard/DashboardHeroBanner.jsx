    ...
    <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs'>
      <div className='space-y-1'>
        <div className='flex items-center gap-2'>
          <h1 className='text-xl sm:text-2xl font-bold text-slate-900 tracking-tight'>Welcome back, {userName} 👋</h1>
          <span className='px-3 py-0.5 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200'>Manager</span>
        </div>
        <p className='text-xs sm:text-sm text-slate-500 font-medium'>Real-time project operations, team capacity metrics, and actionable deliverables.</p>
      </div>
