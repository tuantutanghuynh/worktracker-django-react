...
import { Bell, Wifi, WifiOff, RefreshCw, CheckCheck, ShieldCheck, Trash2, Inbox } from "lucide-react";
...
export default function ManagerNotificationsPage() {
  ...
  const { notifications, unreadCount, wsConnected, loading, fetchNotifications, markAsRead, markAllAsRead, deleteNotification, connectWebSocket } =
      ...
      <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-2xs'>
        <div className='flex items-start gap-4'>
          ...
          <div>
            ...
            <p className='text-xs text-slate-500 mt-1'>Real-time audit alerts, task approvals, workflow assignments, and timesheet lock notifications.</p>
          </div>
        </div>
