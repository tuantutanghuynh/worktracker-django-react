        ...
        <table className="w-full table-fixed text-left text-sm">
          <thead className="bg-slate-50">
            <tr>
              ...
              <SortableHeader label="Department" sortKey="department_name" ordering={ordering} onSort={toggleSort} className="w-32" />
              <SortableHeader label="Month Hours" sortKey="month_hours" ordering={ordering} onSort={toggleSort} className="w-44" />
              <SortableHeader label="Avg/Day" sortKey="avg_per_day" ordering={ordering} onSort={toggleSort} className="w-20" />
              <SortableHeader label="Violations" sortKey="violations" ordering={ordering} onSort={toggleSort} className="w-20" />
              <SortableHeader label="Status" sortKey="status" ordering={ordering} onSort={toggleSort} className="w-24" />
              <SortableHeader label="Last Entry" sortKey="last_entry" ordering={ordering} onSort={toggleSort} className="w-24" />
          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {employees.map((emp) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-slate-500 truncate">{emp.department_name || '—'}</td>
                ...
                <td className="px-4 py-3 text-slate-500">{emp.last_entry || '—'}</td>
