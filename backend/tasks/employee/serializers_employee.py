...
class EmployeeTaskAttachmentSerializer(serializers.ModelSerializer):
    uploaded_by_name = serializers.CharField(source='user.full_name', read_only=True)
...
class EmployeeTaskListSerializer(serializers.ModelSerializer):
    ...
    manager_name = serializers.CharField(source='job.manager.full_name', read_only=True)
