...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            # 1. ROLES & DEPARTMENTS
            # -----------------------------------------------------------------
            role_admin, _ = Role.objects.get_or_create(code="ADMIN", defaults={"name": "System Admin"})
            role_manager, _ = Role.objects.get_or_create(code="MANAGER", defaults={"name": "Project Manager"})
            role_employee, _ = Role.objects.get_or_create(code="EMPLOYEE", defaults={"name": "Software Employee"})
