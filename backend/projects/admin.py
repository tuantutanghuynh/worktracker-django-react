...
Description: Django admin panel registrations for client and project job models.
"""
...
class ClientAdmin(admin.ModelAdmin):
    """Admin configuration for client partner entities."""
...
class JobAdmin(admin.ModelAdmin):
    """Admin configuration for project job entities."""
