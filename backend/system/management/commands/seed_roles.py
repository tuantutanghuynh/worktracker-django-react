"""
Module: system.management.commands.seed_roles
Description: Management command to seed standard system roles, permissions, and initial mappings.
"""
...
class Command(BaseCommand):
    """Seed standard roles, permissions, and role-permission mappings into database."""
    help = 'Seed roles, permissions, and role-permission mappings'

    def handle(self, *args, **options):
        """Execute database seeding transaction for system roles and permissions."""
        with transaction.atomic():
            ...
            permissions_data = [
                ...
                {'code': 'department:view',     'name': 'View department list and details'},
